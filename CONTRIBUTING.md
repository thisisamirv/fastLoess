...
```bash
# Clone and branch
git clone https://github.com/thisisamirv/fastLoess.git
cd fastLoess
...
`fastLoess` follows a layered architecture to prevent circular dependencies:
...
5. **Math**: Parallel nD neighborhood search (KD-Tree implementation).
...
- `evaluation_*`: Core logic verification.
